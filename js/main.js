        ...
        if (index === 0) {
            ...
            chart.innerHTML = `
                <svg width="100%" height="100%" viewBox="0 0 400 300">
                    ...
                    <circle cx="100" cy="180" r="30" fill="none" stroke="#94070A" stroke-width="10" stroke-dasharray="78.5, 235.5" transform="rotate(-90 100 180)"/>
                    <text x="100" y="180" text-anchor="middle" font-family="Arial" font-size="14" fill="#94070A">75%</text>
                    <text x="100" y="210" text-anchor="middle" font-family="Arial" font-size="12" fill="#666">学术活动</text>
                    
                    <circle cx="200" cy="180" r="30" fill="none" stroke="#94070A" stroke-width="10" stroke-dasharray="94.2, 219.8" transform="rotate(-90 200 180)"/>
                    <text x="200" y="180" text-anchor="middle" font-family="Arial" font-size="14" fill="#94070A">90%</text>
                    <text x="200" y="210" text-anchor="middle" font-family="Arial" font-size="12" fill="#666">文体活动</text>
                    
                    <circle cx="300" cy="180" r="30" fill="none" stroke="#94070A" stroke-width="10" stroke-dasharray="62.8, 251.2" transform="rotate(-90 300 180)"/>
                    <text x="300" y="180" text-anchor="middle" font-family="Arial" font-size="14" fill="#94070A">50%</text>
