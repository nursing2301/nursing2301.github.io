        ...
        if (index === 0) {
            ...
            chart.innerHTML = `
                <svg width="100%" height="100%" viewBox="0 0 400 300">
                    ...
                    <text x="200" y="30" text-anchor="middle" font-family="Arial" font-size="16" fill="#666">大二综测成绩分布</text>
                    ...
                    <text x="30" y="190" text-anchor="middle" font-family="Arial" font-size="12" fill="#666">5</text>
                    <text x="30" y="140" text-anchor="middle" font-family="Arial" font-size="12" fill="#666">10</text>
                    <text x="30" y="90" text-anchor="middle" font-family="Arial" font-size="12" fill="#666">15</text>
                    <text x="30" y="40" text-anchor="middle" font-family="Arial" font-size="12" fill="#666">20</text>
                    <rect x="80" y="240" width="40" height="10" fill="#94070A"/>
                    <rect x="140" y="170" width="40" height="80" fill="#94070A"/>
                    <rect x="200" y="100" width="40" height="150" fill="#94070A"/>
                    <rect x="260" y="240" width="40" height="10" fill="#94070A"/>
                    <text x="100" y="270" text-anchor="middle" font-family="Arial" font-size="12" fill="#666">60-70</text>
                    <text x="160" y="270" text-anchor="middle" font-family="Arial" font-size="12" fill="#666">70-80</text>
                    <text x="220" y="270" text-anchor="middle" font-family="Arial" font-size="12" fill="#666">80-90</text>
                    <text x="280" y="270" text-anchor="middle" font-family="Arial" font-size="12" fill="#666">>90</text>
                </svg>
            `;
        } else if (index === 1) {
            // 活动参与情况图表
